...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_intra&task=polls.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="pollList">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_intra&task=poll.edit&id='.(int) $item->id); ?>">
