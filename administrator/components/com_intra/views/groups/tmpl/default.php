...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_intra&task=groups.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="groupList">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_intra&task=group.edit&id='.(int) $item->id); ?>">
