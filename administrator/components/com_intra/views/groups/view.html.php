 ...
 * @since  1.6
 */
class IntraViewGroups extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		IntraHelpersIntra::addSubmenu('groups');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_INTRA_TITLE_GROUPS'), 'groups.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_intra&view=groups');
        ...
        $form = JForm::getInstance('com_intra.group', 'group');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_INTRA_GROUPS_NAME'),
			'a.`department`' => JText::_('COM_INTRA_GROUPS_DEPARTMENT'),
		);
	}
}
