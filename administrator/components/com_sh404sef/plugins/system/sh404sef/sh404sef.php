...
class plgSystemSh404sef extends JPlugin
{
	...
	public function onContentPrepare($context, &$row, &$params, $page = 0)
	{
		...
		if (is_object($row))
		{
			$row->text = $this->searchOGPImage($row->text, Sh404sefFactory::getConfig());;
		}
		else
		{
			$row = $this->searchOGPImage($row, Sh404sefFactory::getConfig());;
		}
	...
	private function searchOGPImage($content, $config)
	{
