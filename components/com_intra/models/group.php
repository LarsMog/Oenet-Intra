 ...
 * @since  1.6
 */
class IntraModelGroup extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_intra.edit.group.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_intra.edit.group.id', $id);
		}
	 ...
	 */
	public function getTable($type = 'Group', $prefix = 'IntraTable', $config = array())
	{
