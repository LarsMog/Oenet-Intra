 ...
 * @since  1.6
 */
class IntraControllerEvent extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Event', 'Intra_eventsModel');
	...
	public function publish()
	{
		...
		{
			$model = $this->getModel('Event', 'IntraModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_intra&view=events', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		{
			$model = $this->getModel('Event', 'IntrasModel');
			...
			else
			{
				...
				$this->setMessage(JText::_('COM_INTRA_ITEM_DELETED_SUCCESSFULLY'));
			}
